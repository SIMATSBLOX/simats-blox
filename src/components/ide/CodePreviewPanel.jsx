...
export default function CodePreviewPanel({ code }) {
  ...
  const label =
    boardId === 'esp32' ? 'Code · MicroPython (ESP32)' : 'Code · Arduino sketch (C++ / Uno)';
